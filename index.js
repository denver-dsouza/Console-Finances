...
var financedata = (arr, n) => arr.map(x => x[n]);
var profitloss = financedata(finances, 1);
var sum = 0;
...
let average = calculateAverage(profitloss)

let greatestincreasedate ='';
let greatestincrease = 0;
for (let i=1; i<finances.length; i++)
  {
    let value1 = finances[i][1]
    let value2 = finances[i-1][1];
    let increase = value1 - value2;
...
document.write("<br>");
document.write("Average Change: " + average.toPrecision(6));
document.write("<br>");
console.log("Average Change: " + average.toPrecision(6));
